        ...
        <tbody>
            @foreach ($reports as $index => $report)
                <tr>
                    ...
                    <td>
                        <!-- Allow Button -->
                        <form action="{{ route('moderate.allow', [$report->type, $report->report_id]) }}" method="POST"
                        ...
                        <!-- Delete Button -->
                        <form action="{{ route('moderate.delete', [$report->type, $report->report_id]) }}" method="POST"
                            style="display:inline;">
                            @csrf
                            @method('DELETE')
                        ...
                        <!-- View Button -->
                        <a href="{{ route('moderate.view', [$report->type, $report->reported_id]) }}"
